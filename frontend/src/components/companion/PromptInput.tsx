    ...
    return (
      <div className="w-full">
        <textarea
          ...
          maxLength={maxLength}
          className="textarea-bordered textarea h-32 w-full resize-none bg-base-100 text-base-content placeholder:text-base-content/50 focus:border-primary focus:outline-none"
          {...props}
        />
