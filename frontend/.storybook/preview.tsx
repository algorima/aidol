...
import { createClientI18nInstance, AIDOL_NS } from "../src/i18n";
import { aidolTranslations } from "../src/i18n/translations";
...
const withI18next: Decorator = (Story, context) => {
  ...
  const i18nInstance = createClientI18nInstance(lang, {
    [lang]: {
      [AIDOL_NS]: aidolTranslations[lang as keyof typeof aidolTranslations],
    },
  });
